 ...
 */
class Rating extends \SoniaBundle\Entity\Rating implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SoniaBundle\\Entity\\Rating' . "\0" . 'id', '' . "\0" . 'SoniaBundle\\Entity\\Rating' . "\0" . 'idUser', '' . "\0" . 'SoniaBundle\\Entity\\Rating' . "\0" . 'idClub', '' . "\0" . 'SoniaBundle\\Entity\\Rating' . "\0" . 'nbEtoile'];
        }
