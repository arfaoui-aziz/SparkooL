 ...
 */
class Reclamation extends \EtudiantBundle\Entity\Reclamation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EtudiantBundle\\Entity\\Reclamation' . "\0" . 'id', '' . "\0" . 'EtudiantBundle\\Entity\\Reclamation' . "\0" . 'reclamation', '' . "\0" . 'EtudiantBundle\\Entity\\Reclamation' . "\0" . 'anonymously', '' . "\0" . 'EtudiantBundle\\Entity\\Reclamation' . "\0" . 'etudiant'];
        }
    ...
    public function setAnonymously($anonymously)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAnonymously', [$anonymously]);

        return parent::setAnonymously($anonymously);
    }
    ...
    public function getAnonymously()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAnonymously', []);

        return parent::getAnonymously();
    }
