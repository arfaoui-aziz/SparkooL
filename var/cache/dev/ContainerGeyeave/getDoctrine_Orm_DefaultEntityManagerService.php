...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\AdminBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\SoniaBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\ParentBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\EtudiantBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\TeacherBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'AdminBundle\\Entity');
$b->addDriver($c, 'SoniaBundle\\Entity');
$b->addDriver($c, 'ParentBundle\\Entity');
$b->addDriver($c, 'EtudiantBundle\\Entity');
$b->addDriver($c, 'TeacherBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'AdminBundle' => 'AdminBundle\\Entity', 'SoniaBundle' => 'SoniaBundle\\Entity', 'ParentBundle' => 'ParentBundle\\Entity', 'EtudiantBundle' => 'EtudiantBundle\\Entity', 'TeacherBundle' => 'TeacherBundle\\Entity']);
