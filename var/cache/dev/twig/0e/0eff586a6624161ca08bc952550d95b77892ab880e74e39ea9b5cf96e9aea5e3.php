...
class __TwigTemplate_4a55af42f8a3261311639e383ab77ed936f62dbfacbadb4aa94e4e1bb3e74c13 extends \Twig\Template
{
...
<div class=\"container\" id=\"container\">
    ...
    <div class=\"form-container sign-in-container\">
        <form action=\"{{ path(\"fos_user_security_check\") }}\" method=\"post\">
            ...
            {% endif %}
            <div class=\"inputWithIcon\">
                <input type=\"text\" id=\"username\" placeholder=\"Email\" name=\"_username\" value=\"{{ last_username }}\" required=\"required\" autocomplete=\"username\" />
                <i class=\"fa fa-envelope fa-lg fa-fw\" aria-hidden=\"true\"></i>
            </div>
            <div class=\"inputWithIcon\">
                <input type=\"password\" id=\"password\" placeholder=\"Password\" name=\"_password\" required=\"required\" autocomplete=\"current-password\" />
            ...
            <button type=\"submit\" id=\"_submit\" name=\"_submit\" value=\"{{ 'security.login.submit'|trans }}\">Sign In</button>
        </form>
    </div>
    <div class=\"overlay-container\">
        <div class=\"overlay\">
...
", "@FOSUser/Security/login_content.html.twig", "C:\\wamp64\\www\\SparkIT\\vendor\\friendsofsymfony\\user-bundle\\Resources\\views\\Security\\login_content.html.twig");
    }
}
