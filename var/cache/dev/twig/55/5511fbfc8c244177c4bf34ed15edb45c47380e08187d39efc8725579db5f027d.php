...
class __TwigTemplate_bb2d1cdf877057d5aac2873c68455456155ca9554a2ab2f612136bf0f25000d2 extends \Twig\Template
{
    ...
    <div class=\"dashboard-content-one\">
        ...
        echo "
                    <div class=\"row\">
                        ...
                        ";
        // line 31
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["f"] ?? $this->getContext($context, "f")), "nomEvent", []), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "Kids Activity"]]);
        echo "
                        </div>
        ...
        echo "
                        ...
                        <div class=\"col-xl-3 col-lg-6 col-12 form-group\">
                            ...
                            ";
        // line 39
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["f"] ?? $this->getContext($context, "f")), "description", []), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "The Activity is about"]]);
        echo "
                        </div>
        ...
        echo "
                        ...
                        <div class=\"col-xl-3 col-lg-6 col-12 form-group\">
                            ...
                            ";
        // line 66
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["f"] ?? $this->getContext($context, "f")), "theme", []), 'widget', ["attr" => ["class" => "form-control", "placeholder" => "Soccer"]]);
        echo "
                        </div>
            ...
            <div class=\"card-body\">
                ...
                <form class=\"new-added-form\" method=\"POST\">
                    ...
                    <div class=\"row\">
                        <div class=\"col-xl-3 col-lg-6 col-12 form-group\">
                            <label>Name *</label>
                        {{ form_widget (f.nomEvent, {'attr': {'class':'form-control','placeholder':'Kids Activity'}}) }}
                        </div>
                        ...
                        <div class=\"col-xl-3 col-lg-6 col-12 form-group\">
                            <label>Description *</label>
                            {{ form_widget (f.description , {'attr': {'class':'form-control','placeholder':'The Activity is about'}}) }}
                        </div>
                        ...
                        <div class=\"col-xl-3 col-lg-6 col-12 form-group\">
                            <label> Theme *</label>
                            {{ form_widget (f.theme , {'attr': {'class':'form-control','placeholder':'Soccer'}}) }}
                        </div>
