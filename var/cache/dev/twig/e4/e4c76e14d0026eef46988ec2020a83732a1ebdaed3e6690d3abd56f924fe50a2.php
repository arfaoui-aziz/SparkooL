...
class __TwigTemplate_7f9d1d0669072d5c5b5fb105e53a5196b4df1a55e0de171169dfde169cc720a8 extends \Twig\Template
{
    ...
    <div class=\"container\" style=\"z-index: 2\">
        ...
        echo "
                            ...
                            <div class=\"col-sm-6 input-group form-group\">
                                <div class=\"input-group-prepend\">
                                    <span class=\"input-group-text nobg\"><i class=\"fas fa-user-shield\"></i></span>
                                </div>
                            ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "parent", []), 'widget', ["attr" => ["value" => " {{app.user.id}}"]]);
        echo "
                            </div>
...
";
    ...
    {
        return array (  197 => 99,  166 => 78,  156 => 71,  149 => 67,  131 => 52,  127 => 51,  115 => 42,  103 => 33,  99 => 32,  89 => 25,  85 => 24,  61 => 4,  52 => 3,  30 => 1,);
    }
                ...
                <div class=\"tab-content rounded-bottom shadow bg-white py-4 px-5\">
                    <div class=\"tab-pane fade show active\" id=\"home-moving\" role=\"tabpanel\" aria-labelledby=\"home-moving-tab\">
                        ...
                        <form class=\"row home-moving-form position-relative mb-0\" method=\"post\" novalidate>
                            ...
                            {{ form_widget(form.parent,{'attr': {'value':' {{app.user.id}}' }} ) }}
                            </div>
