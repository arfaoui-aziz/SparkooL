...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'gender', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'userType', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'joiningDate', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'phone', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'picture', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'bloodGroup', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'salaire', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'birthDay', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'occupation', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
