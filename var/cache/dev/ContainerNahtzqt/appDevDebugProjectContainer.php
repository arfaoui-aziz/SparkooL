...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7WD442035W', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y+-XGhWipd', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('djzxmvrzZv', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kAx+2TYubW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lC4XMPnDj1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/views'), '!KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'\\src\\SoniaBundle/Resources/views'), 'Sonia');
        $instance->addPath(($this->targetDirs[3].'\\src\\SoniaBundle/Resources/views'), '!Sonia');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/views'), 'NomayaSocial');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/views'), '!NomayaSocial');
        $instance->addPath(($this->targetDirs[3].'\\src\\ParentBundle/Resources/views'), 'Parent');
        $instance->addPath(($this->targetDirs[3].'\\src\\ParentBundle/Resources/views'), '!Parent');
        $instance->addPath(($this->targetDirs[3].'\\src\\EtudiantBundle/Resources/views'), 'Etudiant');
        $instance->addPath(($this->targetDirs[3].'\\src\\EtudiantBundle/Resources/views'), '!Etudiant');
        $instance->addPath(($this->targetDirs[3].'\\src\\TeacherBundle/Resources/views'), 'Teacher');
        $instance->addPath(($this->targetDirs[3].'\\src\\TeacherBundle/Resources/views'), '!Teacher');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'KnpSnappyBundle' => [
                    'parent' => NULL,
                    'path' => 'C:/wamp64/www/SparkIT/vendor/knplabs/knp-snappy-bundle',
                ...
                'SoniaBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\SoniaBundle'),
                    'namespace' => 'SoniaBundle',
                ],
                'NotificationsBundle' => [
                    'parent' => NULL,
                ...
                'ParentBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ParentBundle'),
                    'namespace' => 'ParentBundle',
                ],
                'EtudiantBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EtudiantBundle'),
                    'namespace' => 'EtudiantBundle',
                ],
                'TeacherBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\TeacherBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SoniaBundle' => 'SoniaBundle\\SoniaBundle',
                'NotificationsBundle' => 'SBC\\NotificationsBundle\\NotificationsBundle',
                'NomayaSocialBundle' => 'Nomaya\\SocialBundle\\NomayaSocialBundle',
                'ParentBundle' => 'ParentBundle\\ParentBundle',
                'EtudiantBundle' => 'EtudiantBundle\\EtudiantBundle',
                'TeacherBundle' => 'TeacherBundle\\TeacherBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sparkool.sparkit@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '123456Admin',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'sparkool.sparkit@gmail.com' => 'SparkooL',
            ],
            ...
            'notifications' => [
                'app_id' => 948338,
                'app_key' => '852b3ecc08612fdd1a1d',
                'app_secret' => '36c0d37b346669b62edc',
                'cluster' => 'eu',
                'encrypted' => false,
            ],
            'buttons.facebook' => [
