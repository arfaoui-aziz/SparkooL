...
return $this->services['AppBundle\\Controller\\DefaultController'] = new \AppBundle\Controller\DefaultController(${($_ = isset($this->services['security.csrf.token_manager']) ? $this->services['security.csrf.token_manager'] : $this->load('getSecurity_Csrf_TokenManagerService.php')) && false ?: '_'});
